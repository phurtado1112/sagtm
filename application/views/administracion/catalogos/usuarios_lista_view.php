<div class="container">
    <h2><center><b>Lista de Usuarios</b></center></h2>
</div>
<div class="container">
    <div class="row">
        <div class="span3 well">
            <div class="block-content collapse in">
                    ...
                    <div class="btn-group" role="group" aria-label="...">
                        <button href="agregar_usuario" type="button" class="btn btn-info">Nuevo Usuario</button>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="usuario_cambio_clave"></a><span class="glyphicon glyphicon-lock"></span></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
